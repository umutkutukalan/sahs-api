...
public enum BadgeType {
        ...
        FOUNDER("Kurucu Sahne", "Platformn ilk kurucu üyelerinden biri.", BadgeCategory.SPECIAL, 1),
        FIRST_REHEARSAL("İlk Selam", "İlk provasını paylaşanlara verilir.", BadgeCategory.CONTENT_COUNT, 1),
        STAGE_DUST("Sahne Tozu", "10 içerik. Artık buralısın, ücretli sahne yetkisi kazandın!",
                        BadgeCategory.CONTENT_COUNT,
                        10),
