...
public class UserSocialMediaController {
    ...
    public ResponseEntity<SocialMediaPlatform> updateMySocial(
            @PathVariable Long platformId,
            @Valid @RequestBody SocialMediaRequest request,
            Principal principal) {
        SocialMediaPlatform updated = socialMediaService.updatePlatform(principal.getName(), platformId, request);
