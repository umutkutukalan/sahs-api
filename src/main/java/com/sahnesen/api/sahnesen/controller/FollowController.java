...
public class FollowController {
    ...
    // Kullanıcının takipçilerini sayfalayarak listele (Username ile)
    ...
    public ResponseEntity<List<FollowDTO>> getFollowers(
        ...
        return ResponseEntity.ok(followService.getFollowersByUsername(username, pageable));
    }

    // Kullanıcının takip ettiklerini sayfalayarak listele (Username ile)
    ...
    public ResponseEntity<List<FollowDTO>> getFollowing(
            ...
            @RequestParam(defaultValue = "6") int size) {
        Pageable pageable = PageRequest.of(page, size, Sort.by("createdAt").descending());
        return ResponseEntity.ok(followService.getFollowingByUsername(username, pageable));
    }
