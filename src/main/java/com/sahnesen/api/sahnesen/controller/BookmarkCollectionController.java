...
public class BookmarkCollectionController {
    ...
    public ResponseEntity<Void> addPostToCollection(
        ...
        collectionService.addPostToCollection(principal.getName(), collectionId, postId);
    ...
    public ResponseEntity<BookmarkCollection> updateCollection(
            Principal principal,
            @PathVariable Long collectionId,
            @RequestBody CreateCollectionRequest request) {
        if (principal == null) {
        ...
        return ResponseEntity.ok(collectionService.updateCollection(principal.getName(), collectionId, request));
    }
